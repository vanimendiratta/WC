    ...
    <div>
      <section className="contact" id="contact">
        <div className="container">
          <div className=" flex  align-middle justify-between flex-wrap px-3" id='fot'>
            <aside className="col-4">
              <h3>Call</h3>
              <a href="tel:9990515173">9990515173/<br /> 9990515174</a>
            </aside>
            <aside className="col-4">
              <h3>E-mail</h3>
              <a href="mailto:info@whytecollar.com">info@whytecollar.com</a>
            </aside>
            <aside className="col-4">
              <h3>Follow</h3>
              <div className=" flex justify-center align-middle">
                ...
                <a href="" className="social">
                  ...
                  >
                    <circle cx="481.83" cy="481.83" r="481.33" fill="#fff" />
                    <path
      ...
      <footer>
      <div className=" text-center  text-xl py-5 font-medium">
        &copy; {year.getFullYear()} by White Collar
      </div>
    </footer>
    </div>
  )
