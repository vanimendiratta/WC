...
const Landingpage = () => {
  ...
  return (
    ...
    {["Making Legal", "Consultation ","Accessible" ].map((item, index) => {
    ...
    <h1 className=' text-[2vw] text-[white]  px-20'>Our mission is to simplify access to legal guidance for businesses and individuals.</h1>
