...
const Landingpage = () => {
  ...
  return (
    ...
    {["Health Care", "Consultation ","Services" ].map((item, index) => {
    ...
    <div className='w-[70vw]'>
      <h1 className=' text-center font-medium text-2xl text-white px-16 '> Explore our personalized and supportive health care consultation services to improve your well-being</h1>
    </div>
